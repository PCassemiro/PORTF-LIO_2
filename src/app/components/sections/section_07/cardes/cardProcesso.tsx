  ...
  return (
    ...
    >
      <Image
        ...
        width={150}
      />
      <CardFooter className="justify-between bg-[#6fff2d] before:bg-white/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-large bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
