...
export default function CardMusic() {
  ...
  return (
    <Card
      isBlurred
      className="border-none bg-amber-900 dark:bg-default-100/50 max-w-[610px]"
      shadow="sm"
    >
      <CardBody>
        <div className="grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center bg-b">
          ...
          <div className="flex flex-col col-span-6 md:col-span-8">
            <div className="flex justify-between items-start">
              <div className="flex flex-col gap-0">
                <h3 className="font-semibold text-foreground/90">Processo</h3>
                <p className="text-small text-foreground/80">6 etapas</p>
                <h1 className="text-large font-medium mt-2">Ideia</h1>
                {/* processos*/}
              </div>
              <Button
                isIconOnly
